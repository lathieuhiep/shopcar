<?php
    ...
    $shopcar_logo_image_id    =   $shopcar_options['shopcar_logo_image']['id'];
    $shopcar_information_show_hide = $shopcar_options['shopcar_information_show_hide'] == '' ? 1 : $shopcar_options['shopcar_information_show_hide'];
?>
...
<header id="home" class="header">
    <nav id="navigation" class="navbar-expand-lg">
        ...
        <?php
        if ( $shopcar_information_show_hide == 1 ) :
                ...
                <div class="header-bottom_warp d-lg-flex align-items-center justify-content-lg-end">
                    <div class="site-logo">
                        <a href="<?php echo esc_url( get_home_url( '/' ) ); ?>" title="<?php bloginfo( 'name' ); ?>">
                            <?php
                                if ( !empty( $shopcar_logo_image_id ) ) :
                                    echo wp_get_attachment_image( $shopcar_logo_image_id, 'full' );
                                else :
                            ...
                            <ul class="main-menu">
                                <li>
                                    <a href="<?php echo get_admin_url().'/nav-menus.php'; ?>">
                                        <?php esc_html_e( 'ADD TO MENU','shopcar' ); ?>
                                    </a>
                                </li>
                            </ul>
