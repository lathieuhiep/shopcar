...
class shopcar_widget_about_text extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'About Text', 'shopcar' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'       =>  esc_html__( 'Title About Text', 'shopcar' ),
                'label_block'   =>  true
            ]
        );
        ...
        $this->start_controls_section(
            'section_text_editor',
            [
                'label' => esc_html__( 'Text Editor', 'shopcar' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   =>  esc_html__( 'Default description', 'shopcar' ),
            ]
        );
        ...
        $this->add_control(
            'align',
            [
                'label'     =>  esc_html__( 'Alignment Title', 'shopcar' ),
        ...
        $this->add_control(
            'text_editor_color',
            [
                'label'     =>  __( 'Text Editor Color', 'shopcar' ),
                'type'      =>  Controls_Manager::COLOR,
                'selectors' =>  [
        ...
        $this->add_control(
            'hide_line',
            [
                'label'     =>  esc_html__( 'Hide Line', 'shopcar' ),
                'type'      =>  Controls_Manager::SELECT,
                'default'   =>  'no',
                'options'   =>  [
                    'no'    =>  esc_html__( 'No', 'shopcar' ),
                    'yes'   =>  esc_html__( 'Yes', 'shopcar' ),
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'margin_bottom_line',
            [
                'label'     =>  esc_html__( 'Margin Bottom Line', 'shopcar' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new shopcar_widget_about_text );