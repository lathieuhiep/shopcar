...
class shopcar_widget_slides extends Widget_Base {
    ...
    public function get_name() {
        return 'shopcar-slides';
    }

    public function get_title() {
        return esc_html__( 'Slides Theme', 'shopcar' );
    }
    ...
    public function get_script_depends() {
        return ['shopcar-elementor-custom'];
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_content',
            [
                'label' => esc_html__( 'Slides', 'shopcar' ),
            ]
        );
        ...
        $repeater->start_controls_tab( 'background', [ 'label' => esc_html__( 'Background', 'shopcar' ) ] );

        $repeater->add_control(
            'slides_image',
            [
                'label'     =>  esc_html__( 'Image', 'shopcar' ),
        ...
        $repeater->add_control(
            'background_size',
            [
                'label' => _x( 'Size', 'Background Control', 'shopcar' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'cover',
                'options' => [
                    'cover' => _x( 'Cover', 'Background Control', 'shopcar' ),
                    'contain' => _x( 'Contain', 'Background Control', 'shopcar' ),
                    'auto' => _x( 'Auto', 'Background Control', 'shopcar' ),
                ],
                'selectors' => [
        ...
        $repeater->add_control(
            'background_overlay',
            [
                'label' => esc_html__( 'Background Overlay', 'shopcar' ),
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__( 'Color', 'shopcar' ),
        ...
        $repeater->start_controls_tab( 'content', [ 'label' => esc_html__( 'Content', 'shopcar' ) ] );

        $repeater->add_control(
            'heading',
            [
                'label' => esc_html__( 'Title & Description', 'shopcar' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Slide Heading', 'shopcar' ),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'description',
            [
                'label' => esc_html__( 'Description', 'shopcar' ),
                'type' => Controls_Manager::TEXTAREA,
                'default' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'shopcar' ),
                'show_label' => false,
            ]
        );
        ...
        $repeater->add_control(
            'button_text',
            [
                'label' => esc_html__( 'Button Text', 'shopcar' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Click Here', 'shopcar' ),
            ]
        );
        ...
        $repeater->add_control(
            'link',
            [
                'label'         =>  esc_html__( 'Link', 'shopcar' ),
                'type'          =>  Controls_Manager::URL,
                'label_block'   =>  true,
                'default'       =>  [
                    'is_external'   =>  'true',
                ],
                'placeholder'   =>  esc_html__( 'https://your-link.com', 'shopcar' ),
            ]
        );

        $repeater->end_controls_tab();

        $repeater->start_controls_tab( 'style', [ 'label' => esc_html__( 'Style', 'shopcar' ) ] );

        $repeater->add_control(
            'custom_style',
            [
                'label' => esc_html__( 'Custom', 'shopcar' ),
                'type' => Controls_Manager::SWITCHER,
                'description' => esc_html__( 'Set custom style that will only affect this specific slide.', 'shopcar' ),
            ]
        );
        ...
        $repeater->add_control(
            'horizontal_position',
            [
                'label' => esc_html__( 'Horizontal Position', 'shopcar' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'left' => [
                        'title' => esc_html__( 'Left', 'shopcar' ),
                        'icon' => 'eicon-h-align-left',
                    ],
                    'center' => [
                        'title' => esc_html__( 'Center', 'shopcar' ),
                        'icon' => 'eicon-h-align-center',
                    ],
                    'right' => [
                        'title' => esc_html__( 'Right', 'shopcar' ),
        ...
        $repeater->add_control(
            'vertical_position',
            [
                'label' => esc_html__( 'Vertical Position', 'shopcar' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'top' => [
                        'title' => esc_html__( 'Top', 'shopcar' ),
                        'icon' => 'eicon-v-align-top',
                    ],
                    'middle' => [
                        'title' => esc_html__( 'Middle', 'shopcar' ),
                        'icon' => 'eicon-v-align-middle',
                    ],
                    'bottom' => [
                        'title' => esc_html__( 'Bottom', 'shopcar' ),
        ...
        $repeater->add_control(
            'text_align',
            [
                'label' => esc_html__( 'Text Align', 'shopcar' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'left' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   =>  [
                    [
                        'heading' => esc_html__( 'Slider 1 Heading', 'shopcar' ),
                        'description' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'shopcar' ),
                        'button_text' => esc_html__( 'Click Here', 'shopcar' ),
                        'link' => '#'
                    ],
                    [
                        'heading' => esc_html__( 'Slider 2 Heading', 'shopcar' ),
                        'description' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'shopcar' ),
                        'button_text' => esc_html__( 'Click Here', 'shopcar' ),
                        'link' => '#'
                    ],
        ...
        $this->add_responsive_control(
            'slides_height',
            [
                'label' => esc_html__( 'Height', 'shopcar' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Slider Options', 'shopcar' ),
        ...
        $this->add_control(
            ...
            [
                'type'          =>  Controls_Manager::SWITCHER,
                'label'         =>  esc_html__('Loop Slider ?', 'shopcar'),
                'label_off'     =>  esc_html__('No', 'shopcar'),
                'label_on'      =>  esc_html__('Yes', 'shopcar'),
                'return_value'  =>  'yes',
                'default'       =>  'yes',
            ]
        );
        ...
        $this->add_control(
            'autoplay',
            [
                'label'         => esc_html__('Autoplay?', 'shopcar'),
                'type'          => Controls_Manager::SWITCHER,
                'label_off'     => esc_html__('No', 'shopcar'),
                'label_on'      => esc_html__('Yes', 'shopcar'),
                'return_value'  => 'yes',
        ...
        $this->add_control(
            'nav',
            [
                'label'         => esc_html__('nav Slider', 'shopcar'),
                'type'          => Controls_Manager::SWITCHER,
                'label_on'      => esc_html__('Yes', 'shopcar'),
                'label_off'     => esc_html__('No', 'shopcar'),
                'return_value'  => 'yes',
        ...
        $this->add_control(
            'dots',
            [
                'label'         => esc_html__('Dots Slider', 'shopcar'),
                'type'          => Controls_Manager::SWITCHER,
                'label_on'      => esc_html__('Yes', 'shopcar'),
                'label_off'     => esc_html__('No', 'shopcar'),
                'return_value'  => 'yes',
        ...
        $this->add_responsive_control(
            'content_max_width',
            [
                'label' => esc_html__( 'Content Width', 'shopcar' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'slides_padding',
            [
                'label' => esc_html__( 'Padding', 'shopcar' ),
        ...
        $this->add_control(
            'heading_spacing',
            [
                'label' => esc_html__( 'Spacing', 'shopcar' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            'heading_color',
            [
                'label' => esc_html__( 'Text Color', 'shopcar' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Button', 'shopcar' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'button_border_width',
            [
                'label' => esc_html__( 'Border Width', 'shopcar' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Border Radius', 'shopcar' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->start_controls_tab( 'normal', [ 'label' => esc_html__( 'Normal', 'shopcar' ) ] );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Background Color', 'shopcar' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_border_color',
            [
                'label' => esc_html__( 'Border Color', 'shopcar' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_tab( 'hover', [ 'label' => esc_html__( 'Hover', 'shopcar' ) ] );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Navigation', 'shopcar' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'conditions' => [
                    'relation' => 'or',
                    'terms' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Arrows', 'shopcar' ),
        ...
        $this->add_control(
            'arrows_size',
            [
                'label' => esc_html__( 'Arrows Size', 'shopcar' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 10,
        ...
        $this->add_control(
            'arrows_color',
            [
                'label' => esc_html__( 'Arrows Color', 'shopcar' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'arrows_color_hover',
            [
                'label' => esc_html__( 'Arrows Color Hover', 'shopcar' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'dots_size',
            [
                'label' => esc_html__( 'Dots Size', 'shopcar' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 5,
        ...
        $this->add_control(
            'dots_color',
            [
                'label' => esc_html__( 'Dots Color', 'shopcar' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'dots_color_hover',
            [
                'label' => esc_html__( 'Dots Color Hover', 'shopcar' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    ?>
        ...
        <div class="element-slides owl-carousel owl-theme" data-settings='<?php echo esc_attr( wp_json_encode( $shopcar_slider_settings ) ); ?>'>

            <?php

            foreach ( $settings['slides_list'] as $item ) :
                $shopcar_slides_link         =   $item['link'];
                        ...
                        <div class="element-slides__item--content">
                            ...
                            <?php if ( !empty( $item['button_text'] ) ) : ?>
                                <div class="element-slides__item--link">
                                    <?php if ( !empty( $shopcar_slides_link['url'] ) ) : ?>
                                        <a href="<?php echo esc_url( $shopcar_slides_link['url'] ); ?>" <?php echo ( $shopcar_slides_link['is_external'] ? 'target="_blank"' : '' ); ?>>
...
Plugin::instance()->widgets_manager->register_widget_type( new shopcar_widget_slides );